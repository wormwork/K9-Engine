...
GAMEENG= game.cpp utility.cpp manager/Manager.cpp manager/LogManager.cpp 2d/Position2D.cpp 3d/Position3D.cpp manager/GraphicsManager.cpp manager/ResourceManager.cpp 3d/Mesh.cpp 3d/Vector3.cpp
#GAME= game.cpp
EXECUTABLE= game		
